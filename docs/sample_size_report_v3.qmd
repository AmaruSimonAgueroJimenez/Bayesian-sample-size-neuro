...
::: {#tab:bfthr}
| True effect $\rho$ | $\mathrm{BF}_{10}>4$ | $\mathrm{BF}_{10}>6$ | $\mathrm{BF}_{10}>10$ |
|:------------------:|---------------------:|---------------------:|----------------------:|
|        0.2         |                 n.a. |                 n.a. |                  n.a. |
|        0.3         |                  159 |                 n.a. |                  n.a. |
|        0.4         |               **90** |                   97 |                   106 |
...
: Required $n$ when component-level evidence is quantified by the default JZS Bayes factor on the partial correlation (two-sided; success = $\ge1$ brain component with $\mathrm{BF}_{10}>u$; $K=20$). "n.a." = not attainable with $n\le160$.
:::
...
| Benchmark: JZS $t$-test $n$/group for $P(\mathrm{BF}_{10}{>}3)\ge0.8$ |       91 |       53 |        34 |        22 |
